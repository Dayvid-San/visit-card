...
const principles = [
  ...
  },
  {
    ...
    description: "Fundei uma comunidade de computação chamada TYTO.club com o propósito de unir profissionais para a aplicação do desenvolvimento acadêmico independente na sociedade civil. Também fundei e incentivei a criação de ligas acadêmicas e clubes de computação e inovação.",
  },
  {
    icon: Target, 
